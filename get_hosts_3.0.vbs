...
set ws=wscript.createobject("wscript.shell")
fso3.createtextfile("C:\Windows\System32\drivers\etc\DannyWu.txt")
...
iLocal=LCase("C:\Windows\System32\drivers\etc\DannyWu.txt") 
...
Set textFile = fso.OpenTextFile("C:\Windows\System32\drivers\etc\DannyWu.txt", ForReading )   
strText = textFile.ReadAll   
textFile.Close   
outputFile.WriteLine strText 
...
fso3.DeleteFile("C:\Windows\System32\drivers\etc\DannyWu.txt")
